...
encoded_jax, encode, decode, vocab_size_ = load_jax_cached(dataset="english")
...
def get_batch(data: Array, rng_key: PRNGKeyArray) -> Dict[str, Array]:
...
class BigramLanguageModel:
    def __init__(self, learning_rate: float, vocab_size: int):
        self.vocab_size = vocab_size
        self.embeddings = Embeddings.make(Embeddings(dict_size=vocab_size, dim_model=vocab_size, dict_init_scale=0.01))
